...
var app = (function () {
    ...
    /* src\TodoItem.svelte generated by Svelte v3.19.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "todo-item-label svelte-12we2m0");
    			toggle_class(div0, "completed", /*completed*/ ctx[0]);
    			add_location(div0, file, 51, 8, 1265);
    			attr_dev(div1, "class", "todo-item-left svelte-12we2m0");
    			add_location(div1, file, 49, 4, 1098);
    			attr_dev(div2, "class", "remove-item svelte-12we2m0");
    			add_location(div2, file, 53, 4, 1353);
    			attr_dev(div3, "class", "todo-item svelte-12we2m0");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 119, 8, 3196);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "build/icon.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "logo");
    			attr_dev(img, "class", "logo svelte-167mbur");
    			add_location(img, file$1, 115, 74, 2930);
    			attr_dev(a, "href", "https://github.com/Jintze/my-svelte-project");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$1, 115, 4, 2860);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "todo-input svelte-167mbur");
    			attr_dev(input0, "placeholder", "Insert todo item ...");
    			add_location(input0, file$1, 117, 4, 3031);
    			attr_dev(input1, "class", "inner-container-input svelte-167mbur");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 124, 20, 3415);
    			add_location(label, file$1, 124, 13, 3408);
    			add_location(div0, file$1, 124, 8, 3403);
    			add_location(div1, file$1, 125, 8, 3527);
    			attr_dev(div2, "class", "inner-container svelte-167mbur");
    			add_location(div2, file$1, 123, 4, 3364);
    			attr_dev(button0, "class", "svelte-167mbur");
    			toggle_class(button0, "active", /*currentFilter*/ ctx[1] === "all");
    			add_location(button0, file$1, 129, 12, 3641);
    			attr_dev(button1, "class", "svelte-167mbur");
    			toggle_class(button1, "active", /*currentFilter*/ ctx[1] === "active");
    			add_location(button1, file$1, 130, 12, 3753);
    			attr_dev(button2, "class", "svelte-167mbur");
    			toggle_class(button2, "active", /*currentFilter*/ ctx[1] === "completed");
    			add_location(button2, file$1, 131, 12, 3874);
    			add_location(div3, file$1, 128, 8, 3622);
    			attr_dev(button3, "class", "svelte-167mbur");
    			add_location(button3, file$1, 134, 12, 4035);
    			add_location(div4, file$1, 133, 8, 4016);
    			attr_dev(div5, "class", "inner-container svelte-167mbur");
    			add_location(div5, file$1, 127, 4, 3583);
    			attr_dev(div6, "class", "container svelte-167mbur");
    			add_location(div6, file$1, 114, 0, 2831);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*todosRemaining*/ 4) set_data_dev(t5, /*todosRemaining*/ ctx[2]);
    ...
    /* src\WhiteNoise.svelte generated by Svelte v3.19.1 */

    const file$2 = "src\\WhiteNoise.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			audio = element("audio");
    			audio.textContent = "blahblah";
    			if (audio.src !== (audio_src_value = "build/test.flac")) attr_dev(audio, "src", audio_src_value);
    			audio.controls = true;
    			set_style(audio, "margin", "20px 40%");
    			add_location(audio, file$2, 30, 4, 414);
    			add_location(div, file$2, 29, 0, 402);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class WhiteNoise extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$3(ctx) {
    	...
    	const whitenoise = new WhiteNoise({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(todos.$$.fragment);
    			t = space();
    			create_component(whitenoise.$$.fragment);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(whitenoise, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			...
    			transition_in(whitenoise.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(todos.$$.fragment, local);
    			transition_out(whitenoise.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(todos, detaching);
    			if (detaching) detach_dev(t);
    			destroy_component(whitenoise, detaching);
    		}
    	};
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	$$self.$capture_state = () => ({ Todos, WhiteNoise });
    	return [];
    }
